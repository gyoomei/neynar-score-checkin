...
const canonicalDomain =
  ...
  "neynar-score-checkin.vercel.app";

function normalizeHomeUrl(domain: string): string {
...
const homeUrl = normalizeHomeUrl(canonicalDomain);
...
const rawPublicConfig: PublicConfig = {
  ...
  fid: parseInt(process.env.NEXT_PUBLIC_USER_FID || "241470", 10),
